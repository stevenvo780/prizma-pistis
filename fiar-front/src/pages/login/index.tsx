...
const Login = () => {
  ...
  return (
    <>
      <Head><title>Iniciar sesión — Iris</title></Head>
      <div className={styles.loginContainer}>
        <Card className={styles.card}>
          <div className={`${styles.logoContainer} text-center`}>
            <Image fetchPriority="high" src="/img/prizma-symbol.svg" alt="Iris by Prizma" width={72} height={72} style={{ objectFit: 'contain' }} />
          </div>
          <h5 className="text-center fw-bold mb-1" style={{ color: 'var(--c-primary-700, #0E6E73)' }}>Bienvenido a Iris</h5>
